...
![image](https://user-images.githubusercontent.com/74751686/112819234-525e5800-90bf-11eb-9ea3-4eacb8ed08e8.png)
...
![image](https://user-images.githubusercontent.com/74751686/112819504-a10bf200-90bf-11eb-960f-208d41a2124e.png)
  ...
  配線:3/2と同じ
- **8/9-8/25活動報告(報告者:田中裕)**
>地下室が使えなくなったことで自宅での開発を余儀なくされた。   
  
>自宅でブラシレスモータを回すことが怖かった(リポバッテリーを持っていることが怖い)のでブラシ付きのマブチモータ(FA-130RA)にてミニドローンを作成することを決定  
  [FA-130RAのデータシート](https://www.mabuchi-motor.co.jp/motorize/branch/motor/pdf/fa_130ra.pdf)  
  
>モーターの回転数を制御するためにトランジスタのスイッチング特性を利用したarduinoのPWM制御を考え、モータ(適正電流500[mA],適正電圧1.5~3.0[V])のスイッチングを満たすトランジスタ(2SC2235)を調達する。   
...
>スロットル(ドローンの上下)の実験を行う
  
  
>ドローン自体の実験機を作成し、姿勢制御が可能かを調べる。
